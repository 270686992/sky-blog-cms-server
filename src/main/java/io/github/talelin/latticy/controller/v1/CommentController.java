...
public class CommentController extends BaseController {
    ...
    public UpdatedVO replyCommentById(@RequestParam(name = "id") @NotNull(message = "{id.not-null}") @Positive(message = "{id.positive}") Integer commentId,
    ...
    public PageResponseVO<CommentDO> getCommentListByPage(@RequestParam(name = "page", required = false, defaultValue = "0")
        ...
        // 获取封装着查询结果信息的分页对象
        IPage<CommentDO> commentPage = this.commentService.getCommentListByPage(page, count);
        // 使用分页对象构建分页视图对象并返回
